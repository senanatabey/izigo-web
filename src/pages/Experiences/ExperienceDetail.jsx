  ...
  return (
    <div className="experience-detail">
      <style>{`
        ...
        .experience-detail .xd-thumb { width: 100%; height: 100%; }
      ...
      <div className="xd-gallery">
        <div className={`xd-thumb ${item.tone}`} />
      </div>

      <div className="xd-layout">
        <div className="xd-main">
          <div className="xd-city"><MapPin size={13} />{item.city}</div>
        ...
        <aside className="xd-sidebar">
          ...
          <div className="xd-host">
            ...
            <div>
              <div className="xd-host-name">{t("villaDetail.hostName")}</div>
